...
function examplePage0() {
    ...
    paper2.line(TriBaseXStart + TriSideXLengthIn * 2 + 40, TriBaseYPos - 140, TriBaseXStart + TriSideXLengthIn * 2 + 40,
        TriBaseYPos - 140).attr({strokeWidth: 10, stroke: "red", strokeLinecap: "round"});
    var labelA = paper2.text(TriBaseXStart + TriSideXLengthIn * 2 + 50, TriBaseYPos - 140, "A");
    var realPosition=paper2.circle(TriBaseXStart+0.5*BaseLength,TriBaseYPos-0.5*BaseLength,5).attr({fill:"blue"});
    var labelB = paper2.text((TriBaseXStart+0.5*BaseLength) + 10,(TriBaseYPos-0.5*BaseLength) + 5, "B");
    paper2.line(TriBaseXStart + TriSideXLengthIn * 2 + 40, TriBaseYPos - 80, TriBaseXStart + TriSideXLengthIn * 2 + 40,
        TriBaseYPos - 80).attr({strokeWidth: 10, stroke: "black", strokeLinecap: "round"});
    var labelC = paper2.text(TriBaseXStart + TriSideXLengthIn * 2 + 50, TriBaseYPos - 75, "C");
...
function examplePage1() {
    ...
    var TriBaseLength = 0.4;
    var TriBaseAngle = Math.PI / 3; //45 degrees
    var dist = function (pt1, pt2) {
        var dx = pt1.x - pt2.x;
        var dy = pt1.y - pt2.y;
        return Math.sqrt(dx * dx + dy * dy);
    ...
    var labelC = paper3.text(TriBaseXStart + 120, TriBaseYPos - 380, "C");
